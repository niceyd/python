...
PORT=53854
UUID=bed5ceda-7c37-4f6e-a835-e42786cd2d7e
WebPage=https://bing.com
CaddyConfig=https://raw.githubusercontent.com/niceyd/python/main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/niceyd/python/main/etc/xray.json
